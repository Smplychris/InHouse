...
})({"engCn":[function(require,module,exports) {
...
module.bundle.HMR_BUNDLE_ID = "095e0f1f1a7ca05b";
"use strict";
...
navElements.forEach((navElement)=>{
    ...
    let hoverLine = (0, _gsap.gsap).timeline({
        paused: true
    });
    hoverLine.from(line, {
        yPercent: 300,
...
let navButtonHover = (0, _gsap.gsap).timeline({
    paused: true
});
...
let heroButtonHover = (0, _gsap.gsap).timeline({
    paused: true
});
...
companies.forEach((company)=>{
    ...
    let companyHover = (0, _gsap.gsap).timeline({
        paused: true
    });
    ...
    companyHover.to(logo, {
        y: -10,
        ease: "power1.inOut",
        duration: 0.4,
        scale: 0.6
    }, "-=0.4");
    companyHover.to(company, {
...
},{"@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}]},["engCn","3cYfC"], "3cYfC", "parcelRequiree56a")

//# sourceMappingURL=index.1a7ca05b.js.map
